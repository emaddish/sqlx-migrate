...
func Exec(db *sqlx.DB, dialect string, m MigrationSource, dir MigrationDirection) (int, error) {
...
//
// Returns the number of applied migrations.
func ExecMax(db *sqlx.DB, dialect string, m MigrationSource, dir MigrationDirection, max int) (int, error) {
...
// Plan a migration.
func PlanMigration(db *sqlx.DB, dialect string, m MigrationSource, dir MigrationDirection, max int) ([]*PlannedMigration, *gorp.DbMap, error) {
...
func GetMigrationRecords(db *sqlx.DB, dialect string) ([]*MigrationRecord, error) {
	dbMap, err := getMigrationDbMap(db, dialect)
	if err != nil {
		return nil, err
	}
...
func getMigrationDbMap(db *sqlx.DB, dialect string) (*gorp.DbMap, error) {
